...
module.exports = cds.service.impl( async function () {
    // Define constants for Risk and BusinessPartners entities from risk-service.cds file
    const { Risks, BusinessPartners } = this.entities;

    /**
     * Set criticality after READ operation on /risks
     */
    ...
    this.on('READ', Risks, async (req, next) => {
        ...
        console.log('Test Ali: ', req.query.SELECT.columns);
